...
export default class extends Controller {
  static targets = ["intro", "game", "movie", "waifood", "omniquill", "welcome", "ibutton", "pbutton"]
  connect() {
  }
  ...
  introclicked() {
    ...
    this.omniquillTarget.classList.add("d-none");
  ...
  projectclicked() {
    ...
    this.omniquillTarget.classList.add("fade-in");
    this.omniquillTarget.classList.remove("d-none");
